...
The docker on first run will download the same version as tagged of `All the Mods 9 - To the Sky` and install it.  This can take a while as the Forge installer can take a bit to complete.  You can watch the logs and it will eventually finish.
...
* MOTD "All the Mods 9 - To the Sky Server Powered by Docker"
* LEVEL world
